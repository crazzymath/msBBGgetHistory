:Begin:
:Function:       msBBGgetHistory
:Pattern:        msBBGgetHistory[ticker_String, field_String, startDate_String, endDate_String, periodicitySelection_String, periodicityAdjustment_String, useDPDF_Integer, debug_Integer]
